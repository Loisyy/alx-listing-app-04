...
// Define the proper type for booking details
interface BookingDetails {
  ...
  bookingFee: number;
  imageUrl: string;
  rating?: number;       // optional, if you want to display
  totalReviews?: number; // optional, if you want to display
}
    ...
    <div className="flex items-center mt-4">
      ...
      <div className="ml-4">
        ...
        <p className="text-sm text-gray-500">
          {bookingDetails.rating ?? 4.76} ({bookingDetails.totalReviews ?? 345} reviews)
        </p>
        <p className="text-sm text-gray-500">
